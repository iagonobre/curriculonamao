...
export default function Perfil() {
  ...
  const { reset: resetImage, register: registerImage, handleSubmit: handleSubmitImage } = useForm()
          ...
          <div className={styles.boxContent}>
            <div className={styles.profileForm}>
              ...
              <form id="contentform" onSubmit={handleSubmit(onSubmit)} >
                ...
                />
                <Button type="submit" disabled form="contentform">Carregando...</Button>
              </form>
            </div>
            ...
            <div className={styles.profileContent}>
              <h3>Editar Perfil</h3>
              <div />
              <Link href="/recovery"><a>Alterar minha senha</a></Link>
      ...
      <div className={styles.container}>
        <div className={styles.boxContent}>
          <div className={styles.profileForm}>
            ...
            <div className={styles.imageContainer}>
              <Image src={photoURL} alt="Foto de perfil" width="100" height="100" layout='fixed' />
              <form id="photo" onChange={handleSubmitImage(onSubmitImage)} className={styles.buttonsContainer}>
                <label htmlFor="file">{loading ? 'Enviando...' : 'Escolher Imagem'}</label>
                <input id="file" type="file" {...registerImage("file")} />
              </form>
            </div>
            <form id="contentform" onSubmit={handleSubmit(onSubmit)} >
              ...
              <Input
                ...
                register={register("email")}
              />
              <Button type="submit" form="contentform" disabled={loading}>{loading ? 'Enviando...' : 'EDITAR'}</Button>
            </form>
          </div>
          <div className={styles.line} />
          <div className={styles.profileContent}>
